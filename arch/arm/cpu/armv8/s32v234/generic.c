			  ...
			  char *const argv[])
{
	...
	printf
	    ("PLL1 main:%5d MHz - PFD1:%5d MHz - PFD2:%5d MHz - PFD3:%5d MHz - PFD4:%5d MHz\n",
	     decode_pll(PLL1, 24000) / 1000, decode_pll(PLL0, 24000) / 1000,
	     decode_pll(PLL1, 24000) / 1000, decode_pll(PLL1, 24000) / 1000,
	     decode_pll(PLL1, 24000) / 1000);
	printf
	    ("PLL2 main:%5d MHz - PFD1:%5d MHz - PFD2:%5d MHz - PFD3:%5d MHz - PFD4:%5d MHz\n",
	     decode_pll(PLL2, 24000, 0) / 1000, decode_pll(PLL2, 24000,
							   1) / 1000,
	     decode_pll(PLL2, 24000, 2) / 1000, decode_pll(PLL2, 24000,
							   3) / 1000,
	     decode_pll(PLL2, 24000, 4) / 1000);
	printf
	    ("PLL3 main:%5d MHz - PFD1:%5d MHz - PFD2:%5d MHz - PFD3:%5d MHz - PFD4:%5d MHz\n",
	     decode_pll(PLL3, 24000, 0) / 1000, decode_pll(PLL3, 24000,
							   1) / 1000,
	     decode_pll(PLL3, 24000, 2) / 1000, decode_pll(PLL3, 24000,
							   3) / 1000,
	     decode_pll(PLL3, 24000, 4) / 1000);
