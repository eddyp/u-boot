...
static const struct sys_mmu_table lsch3_early_mmu_table[] = {
	{ S32V234_IRAM_BASE, S32V234_IRAM_BASE,
	  S32V234_IRAM_SIZE, MT_NORMAL, PMD_SECT_OUTER_SHARE },
	{ S32V234_DRAM_BASE1, S32V234_DRAM_BASE1,
	  S32V234_DRAM_SIZE1, MT_NORMAL_NC, PMD_SECT_OUTER_SHARE },
	{ S32V234_PERIPH_BASE, S32V234_PERIPH_BASE,
	  S32V234_PERIPH_SIZE, MT_DEVICE_NGNRNE, PMD_SECT_NON_SHARE },
	{ S32V234_DRAM_BASE2, S32V234_DRAM_BASE2,
	  S32V234_DRAM_SIZE2, MT_NORMAL_NC, PMD_SECT_OUTER_SHARE },
	{ S32V234_FLASH0_BASE, S32V234_FLASH0_BASE,
	  S32V234_FLASH0_SIZE, MT_NORMAL, PMD_SECT_OUTER_SHARE },
	{ S32V234_FLASH1_BASE, S32V234_FLASH1_BASE,
	  S32V234_FLASH1_SIZE, MT_NORMAL, PMD_SECT_OUTER_SHARE },
};
...
static inline void early_mmu_setup(void)
{
	...
	u64 *level0_table = (u64 *) (S32V234_IRAM_BASE + 0x6000);
	u64 *level1_table0 = (u64 *)(S32V234_IRAM_BASE + 0x7000);
	u64 *level1_table1 = (u64 *)(S32V234_IRAM_BASE + 0x8000);
	u64 *level2_table0 = (u64 *)(S32V234_IRAM_BASE + 0x9000);
	u64 *level2_table1 = (u64 *)(S32V234_IRAM_BASE + 0xA000);
	u64 *level2_table2 = (u64 *)(S32V234_IRAM_BASE + 0xB000);
	...
	set_pgtable_table(level1_table0,
			  S32V234_IRAM_BASE >> SECTION_SHIFT_L1,
			  level2_table0);
	set_pgtable_table(level1_table0,
			  S32V234_PERIPH_BASE >> SECTION_SHIFT_L1,
			  level2_table1);

	set_pgtable_table(level1_table0,
			  S32V234_DRAM_BASE2 >> SECTION_SHIFT_L1,
			  level2_table2);
